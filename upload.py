...
#Comprimir archivos
def mostrar_comprimir_archivos():
    msn_text_comprimir = Label(
        text="archivos comprimidos",
        font="30"
    )
    msn_text_comprimir.place(
        x=600,
        y=650
    )
    window.after(3000, lambda: msn_text_comprimir.destroy())
